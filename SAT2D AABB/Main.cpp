...
#pragma endregion Boundaries section just bounces the object so it does not fly off the side of the screen infinitely.
	...
	// Rotate the objects if you'd like, this will show you how the AABB stays aligned on the X, Y, and Z axes regardless of the object's orientation.
	...
	if (!TestSAT(obj2->GetAABB(), obj1->GetAABB()))
	{
...
int main(int argc, char **argv)
{
	...
	window = glfwCreateWindow(800, 600, "SAT 2D AABB Collision", nullptr, nullptr);
